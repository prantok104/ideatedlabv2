...
import PostOptions from "../../../post-new-shipment/components/PostOptions";
import PickUp from "../../../post-new-shipment/components/load_details/PickUp";
import MapModal from "../../../post-new-shipment/components/MapModal";
import TruckDetailsCheckbox from "../../../post-new-shipment/components/truck-details/TruckDetailsCheckbox";
import TrailerType from "../../../post-new-shipment/components/truck-details/TrailerType";
import Commodities from "../../../post-new-shipment/components/truck-details/Commodities";
import HazmatHandle from "../../../post-new-shipment/components/truck-details/HazmatHandle";
import Measurement from "../../../post-new-shipment/components/truck-details/Measurement";
...
const DuplicateForm = ({id}) => {
  ...
  const handleSelectLocation = (location) => {
    // Update the selected location in the corresponding dropoff location
    if (currentIndex !== null) {
      // Assuming you have a way to update the Formik state
      // This might require a method to set field values in Formik
      // e.g., setFieldValue(`dropoffLocations.${currentIndex}.dropoffLocation`, location.label);
    }
    setModalOpen(false);
  };
