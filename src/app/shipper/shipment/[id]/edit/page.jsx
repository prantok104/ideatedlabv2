...
import { EDIT_SHIPMENT } from '@/utils/permission';
...
const ShipmentEdit = () => {
  ...
  const updatedValues = {
    ...
    pickUpLocation: pickUpLocation
      ...
      : null,
    pickUpDatePicker: dayjs(pickUpDate),
    pickupTime: pickUpTime ? parseApiTimeToInitialValue(pickUpTime) : "any",
    ...
    dropoffTime: dropOffTime ? parseApiTimeToInitialValue(dropOffTime) : "any",
  ...
  return (
    <ShipmentPostForm initialForUpdate={updatedValues} postType='Update' id={id} />
  )
}

export default WithAuthorization(ShipmentEdit, [EDIT_SHIPMENT]);